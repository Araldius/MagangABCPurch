...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $req4  = User::factory()->create(['name' => 'Dina Mariana', 'email' => 'dina@company.local', 'password' => bcrypt('password'), 'role' => 'requester', 'department' => 'HRD']); // User tanpa transaksi
        ...
        // Vendor Jasa
        $v4 = Vendor::create(['vendor_name' => 'PT Solusi IT Nusantara', 'location' => 'Jakarta',  'contact' => '021-5558888', 'status' => 'active']);
        $v5 = Vendor::create(['vendor_name' => 'CV Master Clean',        'location' => 'Semarang', 'contact' => '024-5559999', 'status' => 'active']);
        $v6 = Vendor::create(['vendor_name' => 'PT Bangun Teknindo',     'location' => 'Medan',    'contact' => '061-5557777', 'status' => 'active']);
        // Vendor Inactive
        ...
        $qd1_2 = QuotationDetail::create(['quotation_id' => $quot1->id, 'purchase_request_item_id' => $i1_2->id, 'offered_price_per_item' => 50000, 'offered_quantity' => 20]);
        ...
        $qs1_2 = QuotationSummary::create(['rfq_id' => $rfq1->id, 'quotation_detail_id' => $qd1_2->id, 'is_sent_to_user' => true, 'sent_to_user_at' => now()->subDays(14)]);
        ...
        SelectionItem::create(['vendor_selection_id' => $vs1->id, 'quotation_summary_id' => $qs1_2->id, 'final_price_per_item' => 50000, 'final_quantity' => 20]);
        ...
        $itemC = PurchaseRequestItem::create(['purchase_request_id' => $prSplit->id, 'item_code' => 'ELC-001', 'name' => 'Kabel Roll 50m', 'item_name' => 'Kabel Roll 50m', 'quantity' => 5, 'unit' => 'Roll', 'specification' => 'Vetto 4x1.5mm 50 Meter']);
        ...
        $quotV3 = Quotation::create(['rfq_id' => $rfqSplit->id, 'vendor_id' => $v3->id, 'total_price' => 2000000, 'status' => 'finalized']);
        $qdV3_C = QuotationDetail::create(['quotation_id' => $quotV3->id, 'purchase_request_item_id' => $itemC->id, 'offered_price_per_item' => 400000, 'offered_quantity' => 5]);
        ...
        $vsV2 = VendorSelection::create(['rfq_id' => $rfqSplit->id, 'vendor_id' => $v2->id, 'quotation_id' => $quotV2->id, 'decision_notes' => 'Menang Bor', 'decided_at' => now()->subDays(18)]);
        ...
        $vsV3 = VendorSelection::create(['rfq_id' => $rfqSplit->id, 'vendor_id' => $v3->id, 'quotation_id' => $quotV3->id, 'decision_notes' => 'Menang Kabel', 'decided_at' => now()->subDays(18)]);
