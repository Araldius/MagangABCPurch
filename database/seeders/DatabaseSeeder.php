...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
        // ── PR-01: COMPLETED - Pengadaan Perangkat IT (Split PO: Laptopâ†’v1, Mouseâ†’v2) ──
        ...
        // Split PO: Laptopâ†’v1 (lebih murah), Mouseâ†’v2 (lebih murah)
        ...
        History::create(['user_id' => $admin->id, 'rfq_id' => $rfq1->id, 'vendor_selection_id' => $sel1v1->id, 'action' => 'Vendor Selection Submitted', 'transaction_status' => 'completed', 'notes' => 'Split PO: Laptopâ†’PT Tekno Mandiri, Mouseâ†’CV Maju Komputer', 'action_date' => now()->subDays(24)]);
        ...
        $pr2_i2 = PurchaseRequestItem::create(['purchase_request_id' => $pr2->id, 'item_id' => $this->itm(), 'item_name' => 'Natrium Hidroksida (NaOH)', 'quantity' => 30,  'unit' => 'Kg',    'specification' => 'Purity â‰¥97%']);
        ...
        PurchaseRequestItem::create(['purchase_request_id' => $pr5->id, 'item_id' => $this->itm(), 'item_name' => 'Bearing SKF 6205-2RS',   'quantity' => 8, 'unit' => 'Pcs',   'specification' => 'Inner Dia 25mm, 52Ã—15mm']);
        ...
        PurchaseRequestItem::create(['purchase_request_id' => $pr8->id, 'item_id' => $this->itm(), 'item_name' => 'Kardus Box Double Wall 60Ã—40Ã—40', 'quantity' => 500, 'unit' => 'Pcs', 'specification' => 'Kraft paper, pre-printed logo']);
        ...
        PurchaseRequestItem::create(['purchase_request_id' => $pr8->id, 'item_id' => $this->itm(), 'item_name' => 'Pallet Kayu EUR 120Ã—80cm',         'quantity' => 50,  'unit' => 'Pcs', 'specification' => 'Fumigated ISPM 15']);
        ...
        PurchaseRequestItem::create(['purchase_request_id' => $pr10->id, 'item_id' => $this->itm(), 'item_name' => 'Meja Rapat Premium Oval',    'quantity' => 1,  'unit' => 'Unit', 'specification' => 'Kayu jati, 300Ã—120cm, 12 kursi']);
        ...
        $sr1 = ServiceRequest::create([
            'user_id' => $user->id, 'document_number' => 'SR-2026-0001',
        ...
        ServiceRequestItem::create(['job_id' => $sr1_job1->id, 'item_name' => 'Jasa Bongkar Keramik Lantai', 'quantity' => 1,  'unit' => 'Lot', 'specification' => 'Â±50m2, termasuk angkut buang']);
        ...
        ServiceRequestItem::create(['job_id' => $sr1_job2->id, 'item_name' => 'Pemasangan Keramik 60Ã—60',   'quantity' => 50, 'unit' => 'm2',  'specification' => 'Granit polish, termasuk nat']);
        ...
        $sr2 = ServiceRequest::create([
            'user_id' => $user->id, 'document_number' => 'SR-2026-0002',
        ...
        $sr3 = ServiceRequest::create([
            'user_id' => $user2->id, 'document_number' => 'SR-2026-0003',
        ...
        $sr4 = ServiceRequest::create([
            'user_id' => $user2->id, 'document_number' => 'SR-2026-0004',
        ...
        $sr5 = ServiceRequest::create([
            'user_id' => $user->id, 'document_number' => 'SR-2026-0005',
        ...
        $sr6 = ServiceRequest::create([
            'user_id' => $user2->id, 'document_number' => 'SR-2026-0006',
        ...
        $sr7 = ServiceRequest::create([
            'user_id' => $user->id, 'document_number' => 'SR-2026-0007',
        ...
        $sr8 = ServiceRequest::create([
            'user_id' => $user2->id, 'document_number' => 'SR-2026-0008',
        ...
        ServiceRequestItem::create(['job_id' => $sr8_job1->id, 'item_name' => 'Bongkar Lantai Beton Existing', 'quantity' => 150, 'unit' => 'm2',    'specification' => 'Tebal Â±15cm, termasuk disposal']);
        ...
        ServiceRequestItem::create(['job_id' => $sr8_job2->id, 'item_name' => 'Pasang U-Ditch Precast 30Ã—30',  'quantity' => 50,  'unit' => 'Meter', 'specification' => 'Cover besi']);
        ...
        $sr9 = ServiceRequest::create([
            'user_id' => $user->id, 'document_number' => 'SR-2026-0009',
        ...
        ServiceRequestItem::create(['job_id' => $sr9_job1->id, 'item_name' => 'Kalibrasi Thermocouple Type K', 'quantity' => 10, 'unit' => 'Pcs',  'specification' => 'Range -50~1200Â°C, NIST traceable']);
        ...
        $sr10 = ServiceRequest::create([
            'user_id' => $user2->id, 'document_number' => 'SR-2026-0010',
        ...
        $sr11 = ServiceRequest::create([
            'user_id' => $user->id, 'document_number' => 'SR-2026-0011',
        ...
        ServiceRequestItem::create(['job_id' => $sr11_job2->id, 'item_name' => 'Rewiring Bus Bar Copper 100Ã—10', 'quantity' => 20, 'unit' => 'Meter', 'specification' => 'TPN, sleeve heat shrink']);
