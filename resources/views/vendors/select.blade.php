...
@php
    ...
    // Ambil data penawaran lengkap untuk kalkulasi harga
...
function doSubmit() {
    ...
    // Reset isi form menjadi hanya @csrf
    form.innerHTML = '@csrf'; 
    ...
    // Masukkan format selections[] berbentuk array sesuai ekspektasi Controller
    let i = 0;
    for (const [itemId, sel] of Object.entries(selectedItems)) {
